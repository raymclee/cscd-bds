...
// The ProjectStaffFunc type is an adapter to allow the use of ordinary
// function as ProjectStaff mutator.
type ProjectStaffFunc func(context.Context, *ent.ProjectStaffMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProjectStaffFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProjectStaffMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProjectStaffMutation", m)
}
...
// The TenderProfileFunc type is an adapter to allow the use of ordinary
// function as TenderProfile mutator.
type TenderProfileFunc func(context.Context, *ent.TenderProfileMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TenderProfileFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TenderProfileMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TenderProfileMutation", m)
}
