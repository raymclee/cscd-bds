...
func HasCustomersWith(preds ...predicate.Customer) predicate.Area {
	return predicate.Area(func(s *sql.Selector) {
...
func HasTenders() predicate.Area {
	return predicate.Area(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTendersWith(preds ...predicate.Tender) predicate.Area {
	return predicate.Area(func(s *sql.Selector) {
		step := newTendersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
