...
var (
	...
	CustomerProfilesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{CustomerProfilesColumns[16]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
			{
				Symbol:     "customer_profiles_users_sales",
				Columns:    []*schema.Column{CustomerProfilesColumns[17]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
	...
	ProjectsColumns = []*schema.Column{
		...
		{Name: "revenue_kpi", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "revenue_current_year_completed", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "revenue_accumulated_completed", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "pay_date", Type: field.TypeTime, Nullable: true},
		{Name: "owner_vo_count", Type: field.TypeInt, Nullable: true},
		{Name: "contractor_vo_count", Type: field.TypeInt, Nullable: true},
		{Name: "accumulate_deduction", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "subcontractor_va_count", Type: field.TypeInt, Nullable: true},
		{Name: "contract_supplementary_count", Type: field.TypeInt, Nullable: true},
		{Name: "repair_fee", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
	...
	TenderProfilesColumns = []*schema.Column{
		...
		{Name: "tender_closing_date", Type: field.TypeTime, Nullable: true},
		{Name: "construction_area", Type: field.TypeString, Nullable: true},
		{Name: "tender_amount", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "tender_win_date", Type: field.TypeTime, Nullable: true},
		{Name: "tender_win_amount", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "last_tender_amount", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric"}},
		{Name: "tender_id", Type: field.TypeString},
	...
	TenderProfilesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			},
			{
				...
				Columns:    []*schema.Column{TenderProfilesColumns[69]},
				RefColumns: []*schema.Column{UsersColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
