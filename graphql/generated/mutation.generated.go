...
func (ec *executionContext) field_Mutation_setTenderCompetitor_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Mutation_setTenderCompetitor_argsTenderID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["tenderId"] = arg0
	arg1, err := ec.field_Mutation_setTenderCompetitor_argsCompetitorID(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["competitorId"] = arg1
	arg2, err := ec.field_Mutation_setTenderCompetitor_argsWon(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["won"] = arg2
...
func (ec *executionContext) field_Mutation_setTenderCompetitor_argsTenderID(
	ctx context.Context,
	rawArgs map[string]interface{},
) (xid.ID, error) {
	// We won't call the directive if the argument is null.
...
func (ec *executionContext) field_Mutation_setTenderCompetitor_argsCompetitorID(
	ctx context.Context,
	rawArgs map[string]interface{},
) (xid.ID, error) {
	// We won't call the directive if the argument is null.
	...
	if tmp, ok := rawArgs["competitorId"]; ok {
		return ec.unmarshalNID2cscdᚑbdsᚋstoreᚋentᚋschemaᚋxidᚐID(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_setTenderCompetitor_argsWon(
	ctx context.Context,
	rawArgs map[string]interface{},
) (bool, error) {
	// We won't call the directive if the argument is null.
...
func (ec *executionContext) _Mutation_setTenderCompetitor(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_setTenderCompetitor(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().SetTenderCompetitor(rctx, fc.Args["tenderId"].(xid.ID), fc.Args["competitorId"].(xid.ID), fc.Args["won"].(bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_setTenderCompetitor(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_setTenderCompetitor_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
