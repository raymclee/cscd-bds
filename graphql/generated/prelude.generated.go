...
func (ec *executionContext) unmarshalOFloat2ᚕᚕfloat64(ctx context.Context, v interface{}) ([][]float64, error) {
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalOFloat2ᚕfloat64(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) marshalOFloat2ᚕᚕfloat64(ctx context.Context, sel ast.SelectionSet, v [][]float64) graphql.Marshaler {
	...
	ret := make(graphql.Array, len(v))
	for i := range v {
		ret[i] = ec.marshalOFloat2ᚕfloat64(ctx, sel, v[i])
	}
...
func (ec *executionContext) marshalOID2ᚕcscdᚑbdsᚋstoreᚋentᚋschemaᚋxidᚐIDᚄ(ctx context.Context, sel ast.SelectionSet, v []xid.ID) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
...
func (ec *executionContext) unmarshalOID2ᚖcscdᚑbdsᚋstoreᚋentᚋschemaᚋxidᚐID(ctx context.Context, v interface{}) (*xid.ID, error) {
	if v == nil {
		return nil, nil
	}
	var res = new(xid.ID)
...
func (ec *executionContext) marshalOID2ᚖcscdᚑbdsᚋstoreᚋentᚋschemaᚋxidᚐID(ctx context.Context, sel ast.SelectionSet, v *xid.ID) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
