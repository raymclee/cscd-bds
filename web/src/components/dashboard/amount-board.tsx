...
export function AmountBoard() {
  ...
  return (
    <div className="@container">
      <Card
        className={cn(
          "flex h-[calc(90vh/3*2)] flex-col overflow-hidden rounded border border-brand bg-transparent text-white shadow-dashboard-card drop-shadow-2xl backdrop-blur",
