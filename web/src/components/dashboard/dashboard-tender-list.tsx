...
import { districtsQuery } from "~/routes/_auth/_dashboard/_map/index.lazy";
  ...
  return (
    <MotionCard
      ...
      className={cn(
        ...
        "h-[clamp(18rem,30dvh,18rem)] overflow-hidden rounded border border-brand bg-transparent text-white shadow-dashboard-card drop-shadow-2xl backdrop-blur",
      )}
    >
