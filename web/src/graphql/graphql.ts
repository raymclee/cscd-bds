...
export type Mutation = {
  __typename?: 'Mutation';
  approveCustomerRequest: Customer;
  ...
  loseTender: Tender;
  rejectCustomerRequest: Customer;
  rejectTender: Tender;
  updateArea: Area;
...
export type MutationApproveCustomerRequestArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationRejectCustomerRequestArgs = {
  id: Scalars['ID']['input'];
};
