/**
 * @generated SignedSource<<b4bf6e43651ddaec5a35cacd784271af>>
...
export type useApproveCustomerMutation$variables = {
  id: string;
};
export type useApproveCustomerMutation$data = {
  readonly approveCustomer: {
    readonly " $fragmentSpreads": FragmentRefs<"customerDetailFragment">;
  };
};
export type useApproveCustomerMutation = {
  response: useApproveCustomerMutation$data;
  variables: useApproveCustomerMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "useApproveCustomerMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
