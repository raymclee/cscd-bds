/**
 * @generated SignedSource<<6d0498d16b93c32dffcc5bc8c6ca04b6>>
...
export type v2PageQuery$variables = {
  first?: number | null | undefined;
  last?: number | null | undefined;
  orderBy?: ReadonlyArray<TenderOrder> | null | undefined;
  userId: string;
};
export type v2PageQuery$data = {
  readonly customers: {
...
export type v2PageQuery = {
  response: v2PageQuery$data;
  variables: v2PageQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "4e8a080a1bf9b4d083848e1d34710108",
    "id": null,
    "metadata": {
      "connection": [
        {
